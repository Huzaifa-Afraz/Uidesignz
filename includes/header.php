...
<!-- End Google Tag Manager -->
    ...
    <!-- jquery link -->
    <link rel="stylesheet" href="./assets/css/video-pop.css">
...
<!-- End Google Tag Manager (noscript) -->  
  ...
  <div class="container-fluid container-lg">
        ...
        <div class="links">
          <ul>
            ...
            <li class=""><a href="/about-us" class="">About us</a></li>
              ...
              <img class="ps-lg- d-none d-lg-inline-block arrow-w-12" src="./assets/img/icons/down-white-arrow.svg" alt="down-white-arrow">
              <img class="ps-lg-2 d-inline-block d-lg-none  arrow-w-16 imgScnd" src="./assets/img/icons/arrow-down.svg" alt="down-black-arrow">
            ...
            <ul>
                ...
                <li class="Noborder"><a href="/design-system-service" >Design System</a></li>
            </ul>
        </div>
            </li>
            ...
            <li class="d-none d-lg-block"><div class="cta-btn d-none d-lg-block">
              <a href="https://calendly.com/uidesign0005/30min" class="btn rounded-pill font-bold btn-solid">Schedule a Meeting</a>
             ...
             <li><div class="cta-btn ps-3 pe-5 mt-4 p-lg-0 d-block d-lg-none">
    ...
    <div class="whatsApp">
    <!--<a target="_blank" href="https://web.whatsapp.com/send?l=&amp;phone=13235225370&amp;text=Hi" class="help" style="position:fixed;bottom:25px; right:20px;  z-index:2;">-->
